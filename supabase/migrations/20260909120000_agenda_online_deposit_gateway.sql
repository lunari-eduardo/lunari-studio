-- ====================================================================
-- Migration: Suporte a escolha de Gateway de Pagamento para Sinal de Agendamento Online
-- 1. Adiciona coluna deposit_gateway em public.agenda_online_links
-- 2. Atualiza a RPC reserve_online_slot para usar v_link.deposit_gateway
-- ====================================================================

ALTER TABLE public.agenda_online_links
ADD COLUMN IF NOT EXISTS deposit_gateway text DEFAULT 'asaas';
...
BEGIN
    ...
    IF v_link.require_deposit AND p_deposit_amount > 0 THEN
        ...
        INSERT INTO public.cobrancas (
            ...
            'pendente', v_deposit_gateway, 'link', jsonb_build_object('absorverTaxa', true)
