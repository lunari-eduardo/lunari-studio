    ...
    return (
      <div className="min-h-screen" style={{ backgroundColor: bgColor, color: textColor }}>
        <CoverRenderer
          ...
          coverVideo={gallery.settings?.coverVideo}
          ctaLabel={gallery.settings?.coverCinema?.ctaLabel}
          contentPosition={gallery.settings?.coverCinema?.contentPosition}
          overlayIntensity={gallery.settings?.coverCinema?.overlayIntensity}
