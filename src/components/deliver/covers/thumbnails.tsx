...
export const CinemaThumbnail: ComponentType<Props> = ({ className }) => (
  <Frame className={className}>
    ...
    <circle cx="80" cy="50" r="16" fill="currentColor" opacity="0.15" />
    <polygon points="76,43 88,50 76,57" fill="currentColor" opacity="0.45" />
    {/* Título bottom-left (padrão) */}
    <rect x="14" y="68" width="60" height="5" fill="currentColor" opacity="0.65" />
    <rect x="14" y="78" width="36" height="3" fill="currentColor" opacity="0.45" />
    {/* Botão de CTA */}
    <rect x="14" y="86" width="30" height="6" fill="none" stroke="currentColor" strokeWidth="1" opacity="0.6" rx="1" />
  </Frame>
);
