---
name: lunari-workflow-engine
description: Regras e padrões para o módulo central de Sessões, Agenda, Workflow, Fotos Extras e integração com o Lunari Gallery.
---
