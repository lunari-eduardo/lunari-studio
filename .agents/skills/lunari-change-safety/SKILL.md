---
name: lunari-change-safety
description: Diretrizes de segurança para realizar alterações sem causar regressões no ecossistema interdependente do Lunari Studio. Use ao planejar ou modificar partes críticas do código.
---
...
* **Execute testes**:
  - Rodar obrigatoriamente `npm run typecheck:changed`.
  - Revisar o `git diff` de ponta a ponta.
  - Rodar `npm run build`.
